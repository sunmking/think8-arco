...
final class Data
{
     ...
     */
    public static function channelLevel($data, $pid = 0, $html = '&nbsp;', $fieldPri = 'cid', $fieldPid = 'pid', $level = 1): array
    {
        if (empty($data)) {
            return [];
        }
     ...
     * @param  int  $level 等级
     */
    public static function channelList($data, $pid = 0, $html = '&nbsp;', $fieldPri = 'cid', $fieldPid = 'pid', $level = 1): array
    {
     ...
     * @param  string  $fieldPid 父id
     */
    public static function tree($data, $title, $fieldPri = 'cid', $fieldPid = 'pid'): array
    {
     ...
     */
    public static function isChild($data, $sid, $pid, $fieldPri = 'cid', $fieldPid = 'pid'): bool
    {
     ...
     */
    public static function hasChild($data, $cid, $fieldPid = 'pid'): bool
    {
        foreach ($data as $d) {
            if ($d[$fieldPid] == $cid) {
                return true;
